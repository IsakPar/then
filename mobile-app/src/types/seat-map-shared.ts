// TODO [Phase 2]: Shared interfaces for cross-platform seat map consistency (Mobile)
// Purpose: Mirror web shared types for consistent data structures across platforms
